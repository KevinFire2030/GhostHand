...
예시 주간보고)
```text
전주에는 온디바이스 기반 AI 검증 PoC 방향성과 활용 시나리오 중심으로 검토를 진행했고 무선 ADB 기반으로 단말 제어가 가능한지 확인하면서, 실제 적용 가능성을 확인해 봤습니다.

아울러, 유관부서 의견도 함께 확인해 봤는데요.

먼저 AX 개발그룹에서는 전반적으로 유의미한 아이디어라는 의견을 줬고 특히 자동화가 어려운 메뉴얼 기반 검증 업무에 한번 적용해 보면 좋을 것 같다는 의견을 줬습니다.

S/W품질팀 허정철 상무님께서도 중장기적으로는 지향해야 할 방향성과 부합한다는 의견을 주셨습니다. 다만 현재 단계에서 즉시 적용하기에는 문제 판별, 즉 결과를 판단하는 영역에서 아직 기술적 한계가 있다는 의견이 있었습니다. 또한 SQE3 그룹에서도 유사한 프로젝트를 진행 중이라고 하여, 향후 협업 시 시너지가 있을 것으로 기대하고 있습니다.

금주에는 SQE3 그룹과 협업 가능성을 검토하고 커뮤니케이션을 진행할 예정입니다.
